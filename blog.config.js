...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Kingsley Qi', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '架构师 旅行家 人生体验家', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://kingsley.cn', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'kingsley,kingsley qi,kingsleyqi,Notion,博客', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    '125cc穿越中国实践者,山河与夜色记录者,Exit the logic，Enter the life,欢迎来到我的世界🎉',
