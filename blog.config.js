...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '架构师|大体验家', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://kingsley.cn', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORDS || 'Notion, 博客', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个摩托佬, Hi，我是一个打工人,Hi，我是一个体验家,欢迎来到我的小窝🎉',
